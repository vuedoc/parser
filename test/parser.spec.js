...
describe('options', () => {
  ...
  it('should do not have a title with options.noName', (done) => {
    const _options = {}

    Object.assign(_options, options)

    _options.noName = true
  ...
  it('should do not have a description with options.noDescription', (done) => {
    const _options = {}

    Object.assign(_options, options)

    _options.noDescription = true
