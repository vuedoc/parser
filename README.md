...
interface ModelEntry extend Entry {
  readonly kind: string = 'model',
  prop: string,
  event: string
}

interface SlotEntry extend Entry {
...
interface PropEntry extend Entry {
...
interface DataEntry extend Entry {
...
interface MethodEntry extend Entry {
