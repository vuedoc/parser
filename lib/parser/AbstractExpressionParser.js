...
const { Syntax, Visibilities } = require('../Enum')

class AbstractExpressionParser extends AbstractParser {
  static parseEntryCategory (entry) {
    AbstractParser.mergeEntryKeyword(entry, 'category')
  }
  ...
  parseEntryComment (entry, node, defaultVisibility = Visibilities.public) {
