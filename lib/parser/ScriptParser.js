...
import { InheritAttrsParser } from './InheritAttrsParser';
import { InlineTemplateParser } from './InlineTemplateParser';

import { NameEntry } from '../entity/NameEntry';
import { DescriptionEntry } from '../entity/DescriptionEntry';
import { KeywordsEntry } from '../entity/KeywordsEntry';

import { Syntax, Properties, Feature, Tag, PropTypesTag } from '../Enum';
...
export class ScriptParser extends AbstractParser {
  ...
  parseBaseClassComponent (node) {
    import('./ClassComponentParser').then(({ ClassComponentParser }) => new ClassComponentParser(this).parse(node));
  }
