...
import { Tag } from '../Enum.js';
import { KeywordsUtils } from '../utils/KeywordsUtils.js';
import { JSDoc, TYPE_LIMIT, TYPE_MIDLE } from '../JSDoc.js';
...
export const SlotParser = {
  parseTemplateSlots(entry: Vuedoc.Entry.SlotEntry, attrsList: Array<{ name: string }>, comment) {
  ...
  extractSlotKeywords(keywords: Vuedoc.Entry.Keyword[]) {
