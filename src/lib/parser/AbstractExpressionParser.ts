...
import { Syntax, Visibility } from '../Enum.js';
import { Vuedoc } from '../../../types/index.js';
import * as Babel from '@babel/types';
import { ScriptParser } from './ScriptParser.js';

export class AbstractExpressionParser extends AbstractParser<Vuedoc.Parser.Script, ScriptParser<any, any>> {
  ...
  parseEntryComment(entry: Vuedoc.Entry.TypeKeywords, node, defaultVisibility = Visibility.public) {
  ...
  parseObjectExpressionProperty(node: Babel.ObjectProperty | Babel.ObjectMethod) {}
