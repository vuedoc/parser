...
import { Visibility, Visibilities } from '../Enum.js';
...
export const CommentParser = {
  parse(text: string, defaultVisibility = Visibility.public) {
    const result = {
      keywords: [] as Vuedoc.Entry.Keyword[],
  ...
  getVisibility(keywords: Keyword[], defaultValue = Visibility.public): Vuedoc.Parser.Visibility {
    ...
    if (index > -1) {
      ...
      return keywordVisibility.name as Vuedoc.Parser.Visibility;
    }
